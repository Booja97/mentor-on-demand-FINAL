...
public class MentorSkills {
	...
	public MentorSkills(long mentorId, String skillName, String yearsOfExperience, String regDateTime,
	...
	public String toString() {
		return "MentorSkills [id=" + id + ", mentorId=" + mentorId + ", skillName=" + skillName+ ", yearsOfExperience="
